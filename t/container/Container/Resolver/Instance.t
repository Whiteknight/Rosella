// Automatically generated test for Class Rosella.Container.Resolver.Instance
function create_new(var p_args [slurpy], var n_args [slurpy,named])
{
    return new Rosella.Container.Resolver.Instance(p_args:[flat], n_args:[flat,named]);
}
...
class Test_Rosella_Container_Resolver_Instance
{
    ...
    function test_new()
    {
        ...
        var obj = new Rosella.Container.Resolver.Instance();
        self.assert.not_null(obj);
        self.assert.instance_of(obj, class Rosella.Container.Resolver.Instance);
    }


    function Instance()
    {
        self.status.verify("Test Rosella.Container.Resolver.Instance.Instance()");
        var obj = create_new();
