...
class Test_Rosella_Query_Iterable_Flatten
{
    ...
    function test_new()
    {
        ...
        var obj = new Rosella.Query.Iterable.Flatten();
        self.assert.not_null(obj);
        self.assert.instance_of(obj, class Rosella.Query.Iterable.Flatten);
    }


    function Flatten()
    {
        self.status.verify("Test Rosella.Query.Iterable.Flatten.Flatten()");
        var obj = create_new();

        var arg_0 = null;
        var arg_1 = null;
        var result = obj.Flatten(arg_0, arg_1);
    }
